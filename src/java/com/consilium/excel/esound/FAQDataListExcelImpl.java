...
@Service("FAQDataListExcelImpl")
public class FAQDataListExcelImpl implements ExcelInterface {
    @Autowired
    ...
    public ResponseEntity<byte[]> exportExcel(JsonNode jsonNode) throws Exception {
        ...
        try {
            ...
            sql =
                    "       SELECT                                                                                                                                                                                                            " +
                            ...
                            "               QUESTION_ANSWER  A                                                                                                                                                                                        " +
                            "       WHERE                                                                                                                                                                                                             " +
                            "               STATUS<>'D' " + sqlUnitCondition + sqlSectionCondition + " ORDER BY  ORDERTIME DESC                                                                                                                                                                         ";
            ...
            sql =
                    " SELECT                                                                                                                                                                                " +
                            ...
                            " WHERE                                                                                                                                                                                 " +
                            " 	EXISTS(SELECT MAX(LASTUPDATETIME),PID FROM QUESTIONANSWER_RELATION  BB  GROUP BY PID HAVING B.PID=BB.PID AND (B.LASTUPDATETIME=MAX(LASTUPDATETIME)  or MAX(LASTUPDATETIME) is null) ) AND STATUS<>'D' " + sqlUnitCondition + sqlSectionCondition;
        ...
        String path = httpServletRequest.getServletContext().getRealPath("/WEB-INF/report/esound/QAData.xls");

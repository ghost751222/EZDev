...
@Service("ConsiliumSectionDataReportExcelImpl")
public class ConsiliumSectionDataReportExcelImpl extends BaseService implements ExcelInterface {
    ...
    private String excelName = "連絡窗口清單.xls";

    private String reportPath = "/WEB-INF/report/consilium/WinListB.xls";

...
public class ContentInfoForm implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7354222600256629059L;
	private int formVer;
	...
	/**
	 * @return the superUnit
	 */
	public String getSuperUnit() {
		return superUnit;
	}
	/**
	 * @param superUnit the superUnit to set
	 */
	...
	/**
	 * @return the infoChecker
	 */
	public String getInfoChecker() {
		return infoChecker;
	}
	/**
	 * @param infoChecker the infoChecker to set
	 */
	public void setInfoChecker(String infoChecker) {
		this.infoChecker = infoChecker;
	}
	/**
	 * @return the infoCheckTime
	 */
	public String getInfoCheckTime() {
		return infoCheckTime;
	}
	/**
	 * @param infoCheckTime the infoCheckTime to set
	 */
	public void setInfoCheckTime(String infoCheckTime) {
		this.infoCheckTime = infoCheckTime;
	}
	/**
	 * @return the infoAdmin
	 */
	public String getInfoAdmin() {
		return infoAdmin;
	}
	/**
	 * @param infoAdmin the infoAdmin to set
	 */
	public void setInfoAdmin(String infoAdmin) {
		this.infoAdmin = infoAdmin;
	}
	/**
	 * @return the inforAdminTime
	 */
	public String getInforAdminTime() {
		return inforAdminTime;
	}
	/**
	 * @param inforAdminTime the inforAdminTime to set
	 */
	public void setInforAdminTime(String inforAdminTime) {
		this.inforAdminTime = inforAdminTime;
	}

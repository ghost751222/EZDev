        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                 $("#query").click(function(){
                        findOpinionVerifyByUnitIdAndSectionId(userData.unitId, userData.sectionId)
                 })
            })
            ...
            function setUserData(unitId,sectionId){
                ...
                userData.page = "questionOpinionVerify"

            }

            function findOpinionVerifyByUnitIdAndSectionId(unitId,sectionId){
                  ...
                  var method = "get";
                  var url = ctx + "/QuestionAnswer/findOpinionVerify?";

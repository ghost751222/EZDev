            ...
            <ul class="nav nav-tabs nav-pills" id="pills-tab" role="tablist">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu"
                        ...
                        <li data-src="/Excel/Consilium/CallAmountCompareAll">
                            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                aria-selected="false">服務概況表</button>
                        </li>


                        <li data-src="/Excel/Consilium/CallAmountType">
                            <button class="nav-link" id="CallAmountType" data-bs-toggle="pill"
                                aria-selected="false">業務類型分析</button>
                        </li>


                        <li data-src="/Excel/Consilium/CallFlowDetailReport">
                            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                aria-selected="false">派案明細表</button>
                        </li>

                        <li data-src="/Excel/Consilium/ProcessTypeReport">
                            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                aria-selected="false">業務服務類別統計表</button>
                        </li>

                        <li data-src="/Excel/Consilium/LineService">
                            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu"
                        style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 42px);"
                        data-popper-placement="bottom-start">
                        <li data-src="/Excel/Consilium/CaseResponseSubList">
                            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                aria-selected="false">案件處理狀態清單</button>
                        </li>

                        <li data-src="/Excel/Consilium/CaseProcTimeAvgSub">
                            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                aria-selected="false">案件處理時間統計</button>
                        </li>

                        <li data-src="/Excel/Consilium/ContentInfoForm">
                            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu"
                        ...
                        <li data-src="/Excel/Consilium/TalkFlow">
                            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                aria-selected="false">分時話務服務水準表</button>
                        </li>

                        <li data-src="/Excel/Consilium/AgentEfficient">
                            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                aria-selected="false">話務績效統計表</button>
                        </li>


                        <li data-src="/Excel/Consilium/BlackList">
                            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                aria-selected="false">來電號碼比對過濾統計表</button>
                        </li>

                        <li data-src="/Excel/Consilium/IncomeSec">
                            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                aria-selected="false">1996進線量及秒數</button>
                        </li>


                        <li data-src="/Excel/Consilium/WaitSec">
                            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                aria-selected="false">1996等待秒數列表</button>
                        </li>


                        <li data-src="/Excel/Consilium/RISReport">
                            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu"
                        style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 42px);"
                        data-popper-placement="bottom-start">
                        <li data-src="/Excel/Consilium/FAQStatistic">
                            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                aria-selected="false">FAQ統計表</button>
                        </li>


                        <li data-src="/Excel/Consilium/FAQSectionStatistic">
                            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu"
                        ...
                        <li data-src="/Excel/Consilium/FAQDataList">
                            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu"
                        ...
                        <li data-src="/Excel/Consilium/SectionSuperManagerReport">
                            <button class="nav-link" id="sectionData" data-bs-toggle="pill">總連絡窗口清單</button>
                        </li>

                        <li data-src="/Excel/Consilium/SectionDataReport">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu"
                        ...
                        <li data-src="/Excel/Consilium/SatisfactionStatistics">
                            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                aria-selected="false">滿意度調查統計表</button>
                        </li>
                        <li data-src="/Excel/Consilium/SatisfactionList">
                            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu"
                        ...
                        <li data-src="/Excel/Consilium/SectionForecastSampleNumber">
                            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                ...
                <li class="nav-item" data-src="/Excel/Consilium/CallIdentification">
                     <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" aria-selected="false">來電號碼識別</button>
                </li>
            </ul>
